...
describe('app-version controller', function () {

    var $ionicPlatform = void 0;
    ...
    beforeEach(angular.mock.inject(function (_$controller_, _$rootScope_, _$ionicPlatform_) {
    ...
    it('vm.appVersion should be like x.y.z', function () {
